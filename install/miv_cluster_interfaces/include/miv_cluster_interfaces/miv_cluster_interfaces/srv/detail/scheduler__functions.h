...
#ifndef MIV_CLUSTER_INTERFACES__SRV__DETAIL__SCHEDULER__FUNCTIONS_H_
#define MIV_CLUSTER_INTERFACES__SRV__DETAIL__SCHEDULER__FUNCTIONS_H_
...
/// Initialize srv/Scheduler message.
/**
...
/// Finalize srv/Scheduler message.
/**
...
/// Create srv/Scheduler message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * miv_cluster_interfaces__srv__Scheduler_Request__init().
...
/// Destroy srv/Scheduler message.
/**
 * It calls
 * miv_cluster_interfaces__srv__Scheduler_Request__fini()
...
/// Check for srv/Scheduler message equality.
/**
...
/// Initialize array of srv/Scheduler messages.
/**
...
/// Finalize array of srv/Scheduler messages.
/**
 * It calls
 * miv_cluster_interfaces__srv__Scheduler_Request__fini()
...
/// Create array of srv/Scheduler messages.
/**
 * It allocates the memory for the array and calls
 * miv_cluster_interfaces__srv__Scheduler_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Scheduler messages.
/**
 * It calls
 * miv_cluster_interfaces__srv__Scheduler_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Scheduler message array equality.
/**
...
/// Copy an array of srv/Scheduler messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * miv_cluster_interfaces__srv__Scheduler_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_miv_cluster_interfaces
...
/**
 * It calls
 * miv_cluster_interfaces__srv__Scheduler_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_miv_cluster_interfaces
...
/**
 * It allocates the memory for the array and calls
 * miv_cluster_interfaces__srv__Scheduler_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_miv_cluster_interfaces
...
/**
 * It calls
 * miv_cluster_interfaces__srv__Scheduler_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MIV_CLUSTER_INTERFACES__SRV__DETAIL__SCHEDULER__FUNCTIONS_H_
