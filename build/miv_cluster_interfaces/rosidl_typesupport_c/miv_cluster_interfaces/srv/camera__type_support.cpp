...
static const _Camera_Request_type_support_symbol_names_t _Camera_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, miv_cluster_interfaces, srv, Camera_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, miv_cluster_interfaces, srv, Camera_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, miv_cluster_interfaces, srv, Camera_Request)() {
  return &::miv_cluster_interfaces::srv::rosidl_typesupport_c::Camera_Request_message_type_support_handle;
}
...
static const _Camera_Response_type_support_symbol_names_t _Camera_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, miv_cluster_interfaces, srv, Camera_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, miv_cluster_interfaces, srv, Camera_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, miv_cluster_interfaces, srv, Camera_Response)() {
  return &::miv_cluster_interfaces::srv::rosidl_typesupport_c::Camera_Response_message_type_support_handle;
}
...
static const _Camera_type_support_symbol_names_t _Camera_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, miv_cluster_interfaces, srv, Camera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, miv_cluster_interfaces, srv, Camera)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, miv_cluster_interfaces, srv, Camera)() {
  return &::miv_cluster_interfaces::srv::rosidl_typesupport_c::Camera_service_type_support_handle;
}
