...
#ifndef MIV_CLUSTER_INTERFACES__SRV__DETAIL__CAMERA__FUNCTIONS_H_
#define MIV_CLUSTER_INTERFACES__SRV__DETAIL__CAMERA__FUNCTIONS_H_
 ...
 * calls
 * miv_cluster_interfaces__srv__Camera_Request__init().
...
/**
 * It calls
 * miv_cluster_interfaces__srv__Camera_Request__fini()
 ...
 * miv_cluster_interfaces__srv__Camera_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * miv_cluster_interfaces__srv__Camera_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * miv_cluster_interfaces__srv__Camera_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_miv_cluster_interfaces
...
/**
 * It calls
 * miv_cluster_interfaces__srv__Camera_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_miv_cluster_interfaces
...
/**
 * It allocates the memory for the array and calls
 * miv_cluster_interfaces__srv__Camera_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_miv_cluster_interfaces
...
/**
 * It calls
 * miv_cluster_interfaces__srv__Camera_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MIV_CLUSTER_INTERFACES__SRV__DETAIL__CAMERA__FUNCTIONS_H_
